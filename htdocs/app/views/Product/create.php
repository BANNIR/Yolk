...
<div class='container'>
	...
	<form method='post' action=''>
		<label class='form-label'>Title:<input type='text' name='publication_title' class='form-control' /></label><br>
		<label for="publication_text">Text:</label>
		<textarea id="publication_text" name="publication_text" rows="5" cols="150">Here, write anything you would like!</textarea>
